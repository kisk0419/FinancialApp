<h2><?php echo $family_name ?>家 <?php echo $year . '年' . $month . '月期'?> 積立</h2>

<div>
<table id="detail_list" cellspacing="0" cellpadding="0" class="striped tight">
    <thead>
        <?php echo $this->Html->tableHeaders(
                array('日付', 'カテゴリ１', 'カテゴリ２', '金額', 'エントリーID', '入力者', 'アクション', '', '')); ?>
    </thead>
    <tbody>
...
<div>
    <?php echo $this->Html->link('積立追加', '/FundEntries/regist?year=' . $year . '&month=' . $month); ?>
</div>
<div>
